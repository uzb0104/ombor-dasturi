      ...
      return {
        ...
        login: async (email, password) => {
          try {
            ...
            get().logAudit({
              action: "login",
              entity: "session",
              summary: `${data.user.name} tizimga kirdi`,
            });
        ...
        logout: () => {
          get().logAudit({
            action: "logout",
            entity: "session",
            summary: `${get().user?.name || ""} tizimdan chiqdi`,
          });
          apiLogout();
          set({ user: null });
        },
        ...
        addAppUser: (u) => {
          ...
          get().logAudit({
            ...
            entity: "user",
            entityId: id,
            summary: `Yangi foydalanuvchi: ${u.name} (${u.role})`,
          });
        },
        updateAppUser: (id, u) => {
          ...
          get().logAudit({
            ...
            entity: "user",
            entityId: id,
            summary: `Foydalanuvchi yangilandi: ${prev?.name}`,
          });
        },
        deleteAppUser: (id) => {
          const prev = get().appUsers.find((x) => x.id === id);
          ...
          get().logAudit({
            ...
            entity: "user",
            entityId: id,
            summary: `Foydalanuvchi o'chirildi: ${prev?.name}`,
          });
        },
        updateProfile: (data) => {
          const u = get().user;
        ...
        changePassword: async (currentPassword, newPassword) => {
          ...
          if (!u) return false;
          try {
            await usersApi.update(u.id, { password: newPassword, oldPassword: currentPassword });
            get().logAudit({
              action: "update",
              entity: "security",
        ...
        addProduct: (p) => {
          ...
          get().logAudit({
            ...
            entity: "product",
            entityId: p.id,
            summary: `Tovar qo'shildi: ${p.name}`,
          });
        },
        updateProduct: (id, p) => {
          ...
          get().logAudit({
            ...
            entity: "product",
            entityId: id,
            summary: `Tovar yangilandi: ${prev?.name}`,
          });
        },
        deleteProduct: (id) => {
          const prev = get().products.find((x) => x.id === id);
          ...
          get().logAudit({
            ...
            entity: "product",
            entityId: id,
            summary: `Tovar o'chirildi: ${prev?.name}`,
          });
        },
        ...
        addCustomer: (c) => {
          ...
          get().logAudit({
            ...
            entity: "customer",
            entityId: c.id,
            summary: `Mijoz qo'shildi: ${c.name}`,
          });
        },
        updateCustomer: (id, c) => {
        ...
        deleteCustomer: (id) => {
          ...
          get().logAudit({
            ...
            entity: "customer",
            entityId: id,
            summary: `Mijoz o'chirildi: ${prev?.name}`,
          });
        },
        ...
        addSupplier: (s) => {
          ...
          get().logAudit({
            ...
            entity: "supplier",
            entityId: s.id,
            summary: `Yetkazib beruvchi: ${s.name}`,
          });
        },
        updateSupplier: (id, s) => {
          ...
          get().logAudit({
            ...
            entity: "supplier",
            entityId: id,
            summary: `Yetkazib beruvchi yangilandi`,
          });
        },
        deleteSupplier: (id) => {
          ...
          get().logAudit({
            ...
            entity: "supplier",
            entityId: id,
            summary: `Yetkazib beruvchi o'chirildi: ${prev?.name}`,
          });
        },
        ...
        deleteEmployee: (id) => {
          ...
          get().logAudit({
            ...
            entity: "employee",
            entityId: id,
            summary: `Xodim o'chirildi: ${prev?.name}`,
          });
        },
        ...
        addSale: (s) => {
          ...
          get().logAudit({
            ...
            entity: "sale",
            entityId: s.id,
            summary: `Sotuv: ${s.total.toLocaleString()} so'm (${s.paymentType})`,
          });
        },
        updateSale: (id, updates) => {
          ...
          if (oldSale.customerId) {
            customers = customers.map((c) => {
              ...
              return {
                ...c,
                debt: Math.max(0, c.debt - oldDebtDelta),
          ...
          get().logAudit({
            ...
            entity: "sale",
            entityId: id,
            summary: `Sotuv yangilandi: ${newSale.total.toLocaleString()} so'm`,
          });
        },
        deleteSale: (id) => {
          ...
          get().logAudit({
            ...
            entity: "sale",
            entityId: id,
            summary: `Sotuv bekor qilindi: ${s.total.toLocaleString()} so'm`,
          });
        },
        ...
        addExpense: (e) => {
          ...
          get().logAudit({
            ...
            entity: "expense",
            entityId: e.id,
            summary: `Xarajat: ${e.category} — ${e.amount.toLocaleString()} so'm`,
          });
        },
        updateExpense: (id, e) => {
        ...
        deleteExpense: (id) => {
          ...
          get().logAudit({
            ...
            entity: "expense",
            entityId: id,
            summary: `Xarajat o'chirildi: ${prev?.category}`,
          });
        },
        ...
        addIncoming: (i) => {
          ...
          get().logAudit({
            ...
            entity: "incoming",
            entityId: i.id,
            summary: `Kirim: ${prod?.name || ""} +${i.qty} dona`,
          });
        },
        updateIncoming: (id, updates) => {
          ...
          if (oldInc.productId === newInc.productId) {
            ...
            products = products.map((p) =>
              p.id === newInc.productId ? { ...p, quantity: Math.max(0, p.quantity + qtyDiff) } : p,
            );
          } else {
            products = products.map((p) => {
              if (p.id === oldInc.productId)
                return { ...p, quantity: Math.max(0, p.quantity - oldInc.qty) };
          ...
          if (oldInc.supplierId === newInc.supplierId) {
            ...
            if (costDiff !== 0 && newInc.supplierId) {
              suppliers = suppliers.map((s) =>
                s.id === newInc.supplierId
                  ? { ...s, debt: Math.max(0, (s.debt || 0) + costDiff) }
                  : s,
              );
            }
          } else {
            suppliers = suppliers.map((s) => {
              if (s.id === oldInc.supplierId)
        ...
        deleteIncoming: (id) => {
          ...
          if (!inc) return;
          const products = get().products.map((p) =>
            p.id === inc.productId ? { ...p, quantity: Math.max(0, p.quantity - inc.qty) } : p,
          );
          const suppliers = get().suppliers.map((s) => {
        ...
        updateCategory: (oldName, newName) => {
          ...
          set({
            ...
            products: get().products.map((p) =>
              p.category === oldName ? { ...p, category: n } : p,
            ),
          });
        ...
        updateVehicleBrand: (oldName, newName) => {
          ...
          set({
            ...
            customers: get().customers.map((c) =>
              c.vehicle === oldName ? { ...c, vehicle: n } : c,
            ),
          });
